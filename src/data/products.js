export const formulations = [
    ...
    { name: 'GAITIN 16', category: 'General', combo: 'Betahistine Hydrochloride Tablets 16 mg', img: '/Product Images RAW/GAITIN 16.png', nameParts: [{ text: 'GAITIN', color: '#7f1d1d' }, { text: ' 16', color: '#f97316' }], pdf: '/Product PDFs/Getin_16.pdf' },
    { name: 'Alpha Neuron D', category: 'Neurology', categories: ['Neurology', 'Multivitamins'], combo: 'Methylcobalamin + Alpha Lipoic Acid + Vitamins', img: '/Product Images RAW/ALPHANEURON D.png', nameParts: [{ text: 'Alpha', color: '#111111' }, { text: ' Neuron', color: '#dc2626' }, { text: ' D', color: '#111111' }], pdf: '/Product PDFs/Alpha_Neuron_D.pdf' },
    { name: 'Omega Pride', category: 'Neurology', categories: ['Neurology', 'Multivitamins'], combo: 'Omega 3 Fatty Acids Softgel Capsules', img: '/Product Images RAW/OMEGA PRIDE.png', nameParts: [{ text: 'Omega', color: '#7c3aed' }, { text: ' Pride', color: '#7c3aed' }], pdf: '/Product PDFs/Omega_Pride.pdf' },
    { name: 'Sudhaxit M', category: 'Neurology', categories: ['Neurology'], combo: 'Flupentixol & Melitracen Tablets', img: '/Product Images RAW/SUDHAXIT M.png', nameParts: [{ text: 'Sudhaxit', color: '#dc2626' }, { text: ' M', color: '#dc2626' }], pdf: '/Product PDFs/Sudhaxit_M.pdf' },
    { name: 'Oxy 1', category: 'Multivitamins', combo: 'Antioxidants with Multivitamins & Minerals', img: '/Product Images RAW/OXYPRIDE-plus.png', nameParts: [{ text: 'Oxy', color: '#dc2626' }, { text: 'pride', color: '#16a34a' }, { text: ' +', color: '#dc2626' }], pdf: '/Product PDFs/Oxy_1.pdf' },
