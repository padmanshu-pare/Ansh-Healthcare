export const formulations = [
    ...
    { name: 'Oxy 1', category: 'Multivitamins', combo: 'Antioxidants with Multivitamins & Minerals', img: '/Product Images RAW/OXYPRIDE +.png', nameParts: [{ text: 'Oxy', color: '#dc2626' }, { text: 'pride', color: '#16a34a' }, { text: ' +', color: '#dc2626' }], pdf: '/Product PDFs/Oxy_1.pdf' },
